...
//                 zIndex: 2
//             }}>
//                 <div className="hero-content" style={{ flex: 1, animation: 'slide-in-right 1s ease' }}>
...
//                     }}>
//                         Hi, I'm <span style={{ color: 'var(--accent-primary)' }}>{data.name}</span>
//                     </h1>
...
//                         maxWidth: '600px',
//                         marginBottom: 'var(--spacing-md)',
//                         marginInline: 'auto' // Centers text on mobile if text-align is center
//                     }}>
//                         {data.description}
//                     </p>
//                     <button style={{
...
//                     <div style={{
//                         width: 'min(350px, 70vw)', // Slightly smaller for better mobile fit
//                         height: 'min(350px, 70vw)',
//                         borderRadius: '50%', // Keep circle but ensure object-fit handles content
//                         overflow: 'hidden',
